...
_LAYERPARAMETER_LAYERTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='CLASSIFICATION_STATS', index=5, number=39,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='FLEXIBLE_DATA', index=15, number=38,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='ID_TO_WEIGHT_MAPPING', index=19, number=42,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='MAX_MARGIN_LOSS', index=25, number=43,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='NORMALIZATION', index=29, number=41,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='RETRIEVAL_STATS', index=33, number=45,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='SIGMOID_CROSS_ENTROPY_LOSS', index=35, number=27,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SILENCE', index=36, number=36,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SOFTMAX', index=37, number=20,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SOFTMAX_LOSS', index=38, number=21,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SPLIT', index=39, number=22,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SLICE', index=40, number=33,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='SUM', index=41, number=44,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='VIDEO_SHOT_WINDOW_DATA', index=43, number=40,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='WINDOW_DATA', index=44, number=24,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='THRESHOLD', index=45, number=31,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_VIDEOSHOTWINDOWDATAPARAMETER_DB = descriptor.EnumDescriptor(
  name='DB',
  full_name='caffe.VideoShotWindowDataParameter.DB',
  filename=None,
  file=DESCRIPTOR,
  values=[
    descriptor.EnumValueDescriptor(
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='VIDEO_ID_TEXT', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_MAXMARGINLOSSPARAMETER_NORM = descriptor.EnumDescriptor(
  name='Norm',
  full_name='caffe.MaxMarginLossParameter.Norm',
  filename=None,
  file=DESCRIPTOR,
  values=[
    descriptor.EnumValueDescriptor(
...
_BLOBPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    descriptor.FieldDescriptor(
      name='truncated_num', full_name='caffe.BlobProto.truncated_num', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='truncated_height', full_name='caffe.BlobProto.truncated_height', index=7,
...
_DATUM = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='mean', full_name='caffe.Datum.mean', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='min', full_name='caffe.Datum.min', index=7,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='max', full_name='caffe.Datum.max', index=8,
...
_SOLVERPARAMETER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='snapshot_vis', full_name='caffe.SolverParameter.snapshot_vis', index=32,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='snapshot_vis_blobs', full_name='caffe.SolverParameter.snapshot_vis_blobs', index=33,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='snapshot_vis_truncate_len', full_name='caffe.SolverParameter.snapshot_vis_truncate_len', index=34,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='snapshot_vis_dir', full_name='caffe.SolverParameter.snapshot_vis_dir', index=35,
...
_LAYERPARAMETER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='classification_stats_param', full_name='caffe.LayerParameter.classification_stats_param', index=14,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='flexible_data_param', full_name='caffe.LayerParameter.flexible_data_param', index=22,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='id_to_weight_mapping_param', full_name='caffe.LayerParameter.id_to_weight_mapping_param', index=26,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='max_margin_loss_param', full_name='caffe.LayerParameter.max_margin_loss_param', index=31,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='retrieval_stats_param', full_name='caffe.LayerParameter.retrieval_stats_param', index=37,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='sum_param', full_name='caffe.LayerParameter.sum_param', index=41,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='video_shot_window_data_param', full_name='caffe.LayerParameter.video_shot_window_data_param', index=44,
...
_TRANSFORMATIONPARAMETER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='use_datum_scales', full_name='caffe.TransformationParameter.use_datum_scales', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIFICATIONSTATSPARAMETER = descriptor.Descriptor(
  name='ClassificationStatsParameter',
  full_name='caffe.ClassificationStatsParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='num_classes', full_name='caffe.ClassificationStatsParameter.num_classes', index=0,
...
_VIDEOSHOTWINDOWDATAPARAMETER = descriptor.Descriptor(
  name='VideoShotWindowDataParameter',
  full_name='caffe.VideoShotWindowDataParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='source', full_name='caffe.VideoShotWindowDataParameter.source', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.VideoShotWindowDataParameter.batch_size', index=1,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='rand_skip', full_name='caffe.VideoShotWindowDataParameter.rand_skip', index=2,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='backend', full_name='caffe.VideoShotWindowDataParameter.backend', index=3,
      number=8, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='num_negative_samples', full_name='caffe.VideoShotWindowDataParameter.num_negative_samples', index=4,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='max_buffer_size', full_name='caffe.VideoShotWindowDataParameter.max_buffer_size', index=5,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='negative_swap_percentage', full_name='caffe.VideoShotWindowDataParameter.negative_swap_percentage', index=6,
      number=11, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='negative_dataset', full_name='caffe.VideoShotWindowDataParameter.negative_dataset', index=7,
  ...
  nested_types=[],
  enum_types=[
    _VIDEOSHOTWINDOWDATAPARAMETER_DB,
  ],
  options=None,
  is_extendable=False,
  extension_ranges=[],
...
_FLEXIBLEDATAPARAMETER = descriptor.Descriptor(
  name='FlexibleDataParameter',
  full_name='caffe.FlexibleDataParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='flexible_source', full_name='caffe.FlexibleDataParameter.flexible_source', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='flexible_key_suffix', full_name='caffe.FlexibleDataParameter.flexible_key_suffix', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='forward_len', full_name='caffe.FlexibleDataParameter.forward_len', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='backward_len', full_name='caffe.FlexibleDataParameter.backward_len', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='use_center_datum', full_name='caffe.FlexibleDataParameter.use_center_datum', index=4,
      number=5, type=8, cpp_type=7, label=1,
...
_SUMPARAMETER = descriptor.Descriptor(
  name='SumParameter',
  full_name='caffe.SumParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='num_output', full_name='caffe.SumParameter.num_output', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IDTOWEIGHTMAPPINGPARAMETER = descriptor.Descriptor(
  name='IdToWeightMappingParameter',
  full_name='caffe.IdToWeightMappingParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='num_output', full_name='caffe.IdToWeightMappingParameter.num_output', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='max_ids', full_name='caffe.IdToWeightMappingParameter.max_ids', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.IdToWeightMappingParameter.weight_filler', index=2,
...
_INNERPRODUCTPARAMETER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='regularization', full_name='caffe.InnerProductParameter.regularization', index=4,
...
_MAXMARGINLOSSPARAMETER = descriptor.Descriptor(
  name='MaxMarginLossParameter',
  full_name='caffe.MaxMarginLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='norm', full_name='caffe.MaxMarginLossParameter.norm', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='id_to_weight_file', full_name='caffe.MaxMarginLossParameter.id_to_weight_file', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RETRIEVALSTATSPARAMETER = descriptor.Descriptor(
  name='RetrievalStatsParameter',
  full_name='caffe.RetrievalStatsParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='id_to_class_file', full_name='caffe.RetrievalStatsParameter.id_to_class_file', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='stats_output_file', full_name='caffe.RetrievalStatsParameter.stats_output_file', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='exclude_same_video_shots', full_name='caffe.RetrievalStatsParameter.exclude_same_video_shots', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['classification_stats_param'].message_type = _CLASSIFICATIONSTATSPARAMETER
...
_LAYERPARAMETER.fields_by_name['flexible_data_param'].message_type = _FLEXIBLEDATAPARAMETER
...
_LAYERPARAMETER.fields_by_name['id_to_weight_mapping_param'].message_type = _IDTOWEIGHTMAPPINGPARAMETER
...
_LAYERPARAMETER.fields_by_name['max_margin_loss_param'].message_type = _MAXMARGINLOSSPARAMETER
...
_LAYERPARAMETER.fields_by_name['retrieval_stats_param'].message_type = _RETRIEVALSTATSPARAMETER
...
_LAYERPARAMETER.fields_by_name['sum_param'].message_type = _SUMPARAMETER
...
_LAYERPARAMETER.fields_by_name['video_shot_window_data_param'].message_type = _VIDEOSHOTWINDOWDATAPARAMETER
...
_VIDEOSHOTWINDOWDATAPARAMETER.fields_by_name['backend'].enum_type = _VIDEOSHOTWINDOWDATAPARAMETER_DB
_VIDEOSHOTWINDOWDATAPARAMETER_DB.containing_type = _VIDEOSHOTWINDOWDATAPARAMETER;
...
_IDTOWEIGHTMAPPINGPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
...
_MAXMARGINLOSSPARAMETER.fields_by_name['norm'].enum_type = _MAXMARGINLOSSPARAMETER_NORM
_MAXMARGINLOSSPARAMETER_NORM.containing_type = _MAXMARGINLOSSPARAMETER;
...
DESCRIPTOR.message_types_by_name['ClassificationStatsParameter'] = _CLASSIFICATIONSTATSPARAMETER
...
DESCRIPTOR.message_types_by_name['VideoShotWindowDataParameter'] = _VIDEOSHOTWINDOWDATAPARAMETER
DESCRIPTOR.message_types_by_name['FlexibleDataParameter'] = _FLEXIBLEDATAPARAMETER
...
DESCRIPTOR.message_types_by_name['IdToWeightMappingParameter'] = _IDTOWEIGHTMAPPINGPARAMETER
...
DESCRIPTOR.message_types_by_name['MaxMarginLossParameter'] = _MAXMARGINLOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['RetrievalStatsParameter'] = _RETRIEVALSTATSPARAMETER
...
class ClassificationStatsParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CLASSIFICATIONSTATSPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.ClassificationStatsParameter)
...
class VideoShotWindowDataParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _VIDEOSHOTWINDOWDATAPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.VideoShotWindowDataParameter)

class FlexibleDataParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FLEXIBLEDATAPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.FlexibleDataParameter)
...
class SumParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SUMPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.SumParameter)
...
class IdToWeightMappingParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _IDTOWEIGHTMAPPINGPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.IdToWeightMappingParameter)
...
class MaxMarginLossParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MAXMARGINLOSSPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.MaxMarginLossParameter)
...
class RetrievalStatsParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _RETRIEVALSTATSPARAMETER
  
  # @@protoc_insertion_point(class_scope:caffe.RetrievalStatsParameter)
