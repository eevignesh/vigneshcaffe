...
stat_file_2='/data2/vigneshr/vigneshcaffe/misc/mednet_pair_relu_1_results_test_12k.txt'
...
output_directory = '/afs/cs.stanford.edu/group/vision/www/vigneshr_data/retrieval_images_old/'
...
# Actually get the images
  for id in range(100): #len(class_ids)):
    i = sorted_ids[id]
...
# Original ret images
      ...
      fig_sub.set_title('fc6: E%d'%top_5_classes[i][k])
# Original ret images
