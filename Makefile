...
# additional proto files which are used by our data layers
INCLUDE_DIRS += #/scail/scratch/u/vigneshr/ICCV2015/code/create_shot_to_sentences/build_tibet/proto
ADDITIONAL_PROTO_OBJS +=  #/scail/scratch/u/vigneshr/ICCV2015/code/create_shot_to_sentences/build_tibet/proto/video_shot_sentences.pb.o
...
$(TEST_ALL_BIN): $(TEST_MAIN_SRC) $(TEST_OBJS) $(GTEST_OBJ) $(STATIC_NAME) \
		| $(TEST_BIN_DIR)
	$(CXX) $(TEST_MAIN_SRC) $(TEST_OBJS) $(GTEST_OBJ) $(ADDITIONAL_PROTO_OBJS) $(STATIC_NAME) \
		-o $@ $(LINKFLAGS) $(LDFLAGS)
	@ echo

$(TEST_CU_BINS): $(TEST_BIN_DIR)/%.testbin: $(TEST_BUILD_DIR)/%.cuo $(GTEST_OBJ) $(STATIC_NAME) \
		| $(TEST_BIN_DIR)
	$(CXX) $(TEST_MAIN_SRC) $< $(GTEST_OBJ) $(ADDITIONAL_PROTO_OBJS)  $(STATIC_NAME) \
		-o $@ $(LINKFLAGS) $(LDFLAGS)
	@ echo
...
$(TOOL_BINS): %.bin : %.o $(STATIC_NAME)
	$(CXX) $< $(ADDITIONAL_PROTO_OBJS) $(STATIC_NAME) -o $@ $(LINKFLAGS) $(LDFLAGS)
	@ echo
