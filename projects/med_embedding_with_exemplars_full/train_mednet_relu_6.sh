...
LOG_DIR="/data2/vigneshr/vigneshcaffe/projects/med_embedding_with_exemplars_full/train_mednet_relu_6_4096_log_dir/"
rm $LOG_DIR/*
GLOG_log_dir=$LOG_DIR ./.build_debug/tools/caffe.bin train \
  --solver=projects/med_embedding_with_exemplars_full/mednet_relu_6_solver.prototxt --gpu=2 \
