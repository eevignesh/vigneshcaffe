...
gflags.DEFINE_string('train_log_file', '/scr/r6/vigneshr/vigneshcaffe/projects/med_embedding_sampled_skipgram/train_mednet_samp_noskipg_8_4096_ret_log_dir/caffe.bin.INFO', 'the training log file')
