...
gflags.DEFINE_string('train_log_file', '/scr/r6/vigneshr/vigneshcaffe/projects/med_embedding_full_window/train_mednet_window_3_4096_ret_log_dir/caffe.bin.INFO', 'the training log file')
