...
/*template <typename Dtype>
void caffe_gpu_axpy_indices(const int n, const int m, const Dtype* X, const int* id, Dtype* Y);
*/
...
/*template <typename Dtype>
void caffe_copy_indices_kernel(const int n, const int m, const Dtype* X, const int* id, Dtype* Y);
