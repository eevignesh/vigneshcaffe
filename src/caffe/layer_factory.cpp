...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_CLASSIFICATION_STATS:
    return new ClassificationStatsLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_FLEXIBLE_DATA:
    return new FlexibleDataLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_ID_TO_WEIGHT_MAPPING:
    return new IdToWeightMappingLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_MAX_MARGIN_LOSS:
    return new MaxMarginLossLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_VIDEO_SHOTS_DATA:
    return new VideoShotsDataLayer<Dtype>(param);
  case LayerParameter_LayerType_VIDEO_SHOT_WINDOW_DATA:
    return new VideoShotWindowDataLayer<Dtype>(param);
